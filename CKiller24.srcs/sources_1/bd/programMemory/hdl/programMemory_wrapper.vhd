...
--Command     : generate_target programMemory_wrapper.bd
--Design      : programMemory_wrapper
...
entity programMemory_wrapper is
  port (
...
end programMemory_wrapper;

architecture STRUCTURE of programMemory_wrapper is
  ...
  end component programMemory;
begin
programMemory_i: component programMemory
     port map (
