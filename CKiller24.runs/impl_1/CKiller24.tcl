...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file CKiller24_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_power_0" "report_power -file CKiller24_power_routed.rpt -pb CKiller24_power_summary_routed.pb -rpx CKiller24_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file CKiller24_route_status.rpt -pb CKiller24_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file CKiller24_timing_summary_routed.rpt -pb CKiller24_timing_summary_routed.pb -rpx CKiller24_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file CKiller24_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file CKiller24_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file CKiller24_bus_skew_routed.rpt -pb CKiller24_bus_skew_routed.pb -rpx CKiller24_bus_skew_routed.rpx"
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force CKiller24_routed_error.dcp
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES XPM_MEMORY [current_project]
  catch { write_mem_info -force CKiller24.mmi }
  write_bitstream -force CKiller24.bit 
  catch {write_debug_probes -quiet -force CKiller24}
  catch {file copy -force CKiller24.ltx debug_nets.ltx}
