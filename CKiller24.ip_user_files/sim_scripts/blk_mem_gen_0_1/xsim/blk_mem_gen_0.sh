...
#
# Generated by Vivado on Tue Apr 07 11:58:08 EDT 2020
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/programMemory.protoinst" -log simulate.log
}
